...
<?php require_once("header.php")?>
    ...
    <div style="background-color: #fef1e4;">
        ...
        <div style="width: 100%; height:175px; margin-top:5px; margin-bottom: 10px;; background-color: #f0913d; color:#372823 ">
            
            <div style="width: 31%; float: left;font-size:25px; text-align:center; margin-left:15px; margin-right:15px; background-color: #fef1e4;">
